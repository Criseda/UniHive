      ...
      <Container className="mt-4 py-4">
        ...
        <Row>
          <Col md={{ span: 8, offset: 2 }}>
            <p className="first-paragraph">
              At UniHive, we uphold the highest standards of ethics and
              integrity. This Code of Ethics outlines our commitment to
              integrity, honesty, and responsibility in all aspects of our
              business operations.
            </p>
          </Col>
        </Row>
        ...
        <Row>
          <Col>
            ...
            <p>
              ...
              contribute positively to society and the environment. We comply
              with applicable laws, regulations, and ethical standards, ensuring
        ...
        <Row>
          <Col>
            ...
            <p>
              We hold ourselves accountable for upholding this Code of Ethics
              and fulfilling our commitments to our users, partners, and
              stakeholders. We welcome feedback and strive to continuously
              improve our ethical practices and business conduct.
            </p>
          </Col>
        </Row>
        <Row>
